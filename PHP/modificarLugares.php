...
$id = $_GET['id'];
$sql = "SELECT * FROM lugar WHERE id_lugar=$id";
...
?>
    ...
    <body>
        ...
        <div class="dialog-contenido">
            <form class="formularioDialog" action="../PHP/updateLugar.php" id="formDialog" method="POST">
                <fieldset>
                    <legend class="legend"> Ingrese el nuevo valor en algún campo </legend>
                    <div class="dialogregistro__texto">
                        <label class="dialogregistro__texto--label" for="">Id Lugar</label>
                        <input class="dialogregistro__texto--input" type="text" name="txtId" id="txtId" value="<?php echo $row['id_lugar'] ?>" readonly>
                    </div>
                    <div class="dialogregistro__texto">
                ...
                <div class="dialogregistro__botones">
                    <input class="dialogregistro__boton--submit" type="submit" value="Modificar Lugar" name="btnModificar">
                    <a class="dialogregistro__boton--submit" href="../HTML/lugares.php">Salir</a>
                </div>
            </form>
        <?php
    }
