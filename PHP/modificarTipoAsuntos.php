...
$id = $_GET['id'];
$sql = "SELECT * FROM tipo_asunto WHERE id_tipo_asunto=$id";
...
?>
    ...
    <body>
        ...
        <div class="dialog-contenido">
            <form class="formularioDialog" action="../PHP/updateTipoAsunto.php" id="formDialog" method="POST">
                <fieldset>
                    ...
                    <div class="dialogregistro__texto">
                        ...
                        <input class="dialogregistro__texto--input" type="text" name="txtId" id="txtId" value="<?php echo $row['id_tipo_asunto'] ?>" readonly>
                    </div>
                    <div class="dialogregistro__texto">
                ...
                <div class="dialogregistro__botones">
                    ...
                    <a class="dialogregistro__boton--submit" href="../HTML/tiposAsuntos.php">Salir</a>
                </div>
            </form>
        <?php
    }
