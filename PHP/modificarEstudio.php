...
$id = $_GET['id'];
$sql = "SELECT * FROM estudio WHERE id_grado=$id";
...
?>
    ...
    <body>
        ...
        <div class="dialog-contenido">
            <form class="formularioDialog" action="../PHP/updateEstudio.php" id="formDialog" method="POST">
                <fieldset>
                    <legend class="legend"> Ingrese el nuevo valor en algún campo </legend>
                    <div class="dialogregistro__texto">
                        <label class="dialogregistro__texto--label" for="">Id grado</label>
                        <input class="dialogregistro__texto--input" type="text" name="txtId" id="txtId" value="<?php echo $row['id_grado'] ?>" readonly>
                    </div>
                    <div class="dialogregistro__texto">
                ...
                <div class="dialogregistro__botones">
                    <input class="dialogregistro__boton--submit" type="submit" value="Modificar grado académico" name="btnModificar">
                    <a class="dialogregistro__boton--submit" href="../HTML/estudios.php">Salir</a>
                </div>
            </form>
        <?php
    }
