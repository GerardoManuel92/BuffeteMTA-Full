...
?>
    ...
    <body>
        ...
        <div class="dialog-contenido">
            <form class="formularioDialog" action="../PHP/updateEstado.php" id="formDialog" method="POST">
                <fieldset>
                    ...
                    <div class="dialogregistro__texto">
                        ...
                        <input class="dialogregistro__texto--input" type="text" name="txtId" id="txtId" value="<?php echo $row['id_estado'] ?>" readonly>
                    </div>
                    <div class="dialogregistro__texto">
                ...
                <div class="dialogregistro__botones">
                    <input class="dialogregistro__boton--submit" type="submit" value="Modificar Estado" name="btnModificar">
                    <a class="dialogregistro__boton--submit" href="../HTML/estados.php">Salir</a>
                </div>
            </form>
        <?php
    }
