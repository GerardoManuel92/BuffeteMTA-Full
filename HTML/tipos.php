...
<div class="cabezal__logo--titulo">
    <p>Tipos de asuntos de Demandas</p>
</div>
                ...
                <fieldset class="fieldset2">
                    ...
                    <div class="registro">
                        <div class="registro__texto">
                            ...
                            <?php
                            $sql2 = "SELECT MAX(id_tipo)+1 as id_tipo FROM tipo";
                    ...
                    <div class="table-wrapper">
                        <table class="tabla-registros">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="tabla-registros--fila">
                                        <td class="tabla-registros--columna"><?php echo $row['id_tipo']; ?></td>
                                        <td class="tabla-registros--columna"><?php echo $row['descripcion']; ?></td>                                        
                                        <td class="tabla-registros--columna"><a href="../PHP/modificarTipo.php?id=<?php echo $row['id_tipo']; ?>"><span class="material-symbols-outlined">
                                                    edit_square
                                                </span></a>

                                        </td>
                                        <td class="tabla-registros--columna"><a href="../PHP/deleteTipo.php?id=<?php echo $row['id_tipo']; ?>"><span class="material-symbols-outlined">
                                                    delete
                                                </span></a></td>
                                    </tr>
                            </tbody>
...
<?php
include "../PHP/registros/registrarTipos.php";
?>